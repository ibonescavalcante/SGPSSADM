        ...
        <div class="card-body">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    //  http://localhost/requisitos/var/www/uploads/documentos/12510/1_10/laudo_pcd_1758745179.pdf
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                        ...
                        <p><a href="/requisitos<?php echo htmlspecialchars($extra_json['documentos']['documento_identidade']); ?>"
                            ...
                            <?php if ($_SESSION['user']['nome'] == 'Administrador') : ?>
                                <!--button class="btn btn-sm btn-outline-primary ms-2" data-bs-toggle="modal"
                                    data-bs-target="#alterarArquivoModal"
                                    data-documento-tipo="documento_identidade">Alterar</button-->
                    ...
                    if (is_array($CUR_HABLITACAO_OPERACIONAL)) {
                        foreach ($CUR_HABLITACAO_OPERACIONAL as $item) {
                            ...
                            if ($_SESSION['user']['nome'] == 'Administrador') {
                                echo '<button class="btn btn-sm btn-outline-primary ms-2" data-bs-toggle="modal" data-bs-target="#alterarArquivoModal" data-documento-tipo="CUR_HABLITACAO_OPERACIONAL">Alterar</button>';
                            }
                            echo '</p>';
                        }
                    ...
                    // echo $CNH;
                    // $CNH_D_EAR = $extra_json['documentos']['CNH_D_EAR'] ?? null;
                    ...
                    if (is_array($CNH)) {
                        foreach ($CNH as $item) {
                            ...
                            if ($_SESSION['user']['nome'] == 'Administrador') {
                                echo '<button class="btn btn-sm btn-outline-primary ms-2" data-bs-toggle="modal" data-bs-target="#alterarArquivoModal" data-documento-tipo="CNH">Alterar</button>';
                            }
                            echo '</p>';
                        }
                    } elseif (!empty($CNH)) {
                    ...
                    if (is_array($comprovante)) {
                        foreach ($comprovante as $item) {
                            ...
                            if ($_SESSION['user']['nome'] == 'Administrador') {
                                echo '<button class="btn btn-sm btn-outline-primary ms-2" data-bs-toggle="modal" data-bs-target="#alterarArquivoModal" data-documento-tipo="comprovante_escolaridade">Alterar</button>';
                            }
                            echo '</p>';
                        }
                    ...
                    if (is_array($CURSO_CONDUTOR_EMERGENCIA)) {
                        foreach ($CURSO_CONDUTOR_EMERGENCIA as $item) {
                            ...
                            if ($_SESSION['user']['nome'] == 'Administrador') {
                                echo '<button class="btn btn-sm btn-outline-primary ms-2" data-bs-toggle="modal" data-bs-target="#alterarArquivoModal" data-documento-tipo="CURSO_CONDUTOR_EMERGENCIA">Alterar</button>';
                            }
                            echo '</p>';
                        }
                        ...
                        <?php foreach ($extra_json['documentos']['comprovante_experiencia_declaracoes'] as $file_path) : ?>
                            <p><a href="/titulos<?php echo htmlspecialchars($file_path); ?>" data-bs-toggle="modal"
                                ...
                                <?php if ($_SESSION['user']['nome'] == 'Administrador') : ?>
                                    <button class="btn btn-sm btn-outline-primary ms-2" data-bs-toggle="modal"
                                        data-bs-target="#alterarArquivoModal"
                                        data-documento-tipo="comprovante_experiencia_declaracoes">Alterar</button>
                                <?php endif; ?>
                            </p>
                        <?php endforeach; ?>
                    <?php endif; ?>
                    ...
                    <?php if (!empty($extra_json['documentos']['certificados']) && is_array($extra_json['documentos']['certificados'])) : ?>
                        <?php foreach ($extra_json['documentos']['certificados'] as $file_path) : ?>
                            <p><a href="/titulos<?php echo htmlspecialchars($file_path); ?>" data-bs-toggle="modal"
                                ...
                                <?php if ($_SESSION['user']['nome'] == 'Administrador') : ?>
                                    <button class="btn btn-sm btn-outline-primary ms-2" data-bs-toggle="modal"
                                        data-bs-target="#alterarArquivoModal" data-documento-tipo="certificados">Alterar</button>
                                <?php endif; ?>
                            </p>
                        <?php endforeach; ?>
                    <?php endif; ?>
