                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <!--li><a class="dropdown-item" href="#"><i class="fas fa-user me-2"></i>Meu Perfil</a>
                                </li>
                                <li><a class="dropdown-item" href="#"><i class="fas fa-cog me-2"></i>Configurações</a>
                                </li>
                                <li><a class="dropdown-item" href="#"><i class="fas fa-bell me-2"></i>Notificações</a>
                                </li>
                                <li><a class="dropdown-item" href="#"><i
                                            class="fas fa-question-circle me-2"></i>Ajuda</a>
                                </li>
                                <li>
                                ...
                                <li><a class="dropdown-item" href="/dashboard/logout"><i
                ...
                <div class="modal-body">
                    <form id="changePasswordForm">
                        ...
                        <div class="mb-3">
                            ...
                            <!--div class="password-strength-meter mt-2" id="passwordStrengthMeter">
                                <div class="strength-bar"></div>
                            </div>
                            <div class="password-requirements">
                                <p class="mb-2">A senha deve atender aos seguintes requisitos:</p>
                                <ul>
                                    <li id="reqLength" class="invalid">Mínimo de 8 caracteres</li>
                                    <li id="reqUppercase" class="invalid">Pelo menos uma letra maiúscula</li>
                                    <li id="reqLowercase" class="invalid">Pelo menos uma letra minúscula</li>
...
<script>
    ...
    submitPasswordChange.addEventListener('click', async function() {
        if (validateForm()) {
            ...
            //             // resetPasswordValidation(); // Se tiver essa função
            //         }
            //     })
            //     .catch(error => {
