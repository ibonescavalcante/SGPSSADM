...
class Database
{
    ...
    {  
        ...
        //para pegar todas as variaveis de am
        ...
        try {
            ...
            $this->connection->exec("SET search_path TO pss, public");
        } catch (PDOException $e) {
            error_log('Database connection failed: ' . $e->getMessage());
            $debug = isset($_ENV['APP_DEBUG']) && filter_var($_ENV['APP_DEBUG'], FILTER_VALIDATE_BOOLEAN);
            die($debug ? 'Erro de conexão: ' . $e->getMessage() : 'Erro de conexão com o banco de dados.');
        }
    }
